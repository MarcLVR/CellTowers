...
```{r}
htmltools::includeHTML("tower_map_Etisalat.html")
htmltools::includeHTML("tower_map_Vodafone.html")
```

-   [Cell Towers Etisalat](tower_map_Etisalat.html)

-   [Cell Towers Vodafone](tower_map_Vodafone.html)

-   [Cell Towers Orange](tower_map_Orange.html)

-   [Cell Towers WE](tower_map_WE.html)
...
-   [GSM Coverage Map](map_radio_GSM.html)

-   [LTE Coverage Map](map_radio_LTE.html)

-   [NR Coverage Map](map_radio_NR.html)

-   [UMTS Coverage Map](map_radio_UMTS.html)
...
-   [General Map Coverage](map_coverage.html)
